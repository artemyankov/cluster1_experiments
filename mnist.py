...
PATH_TO_LOCAL_LOGS = os.path.abspath(os.path.expanduser('~/Documents/Scratch/cluster1_experiments'))
ROOT_PATH_TO_LOCAL_DATA = os.path.abspath(os.path.expanduser('~/Documents/Scratch/cluster1_experiments'))
